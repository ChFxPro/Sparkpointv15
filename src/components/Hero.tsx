...
export function Hero({ heroImage }: HeroProps) {
  ...
  useEffect(() => {
    ...
    // Show buttons right after subheader (0.8s delay after mission)
    ...
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="fixed inset-0 z-0" style={{ height: '100vh' }}>
        ...
        <div
          className="absolute inset-0"
          style={{
            background: 'radial-gradient(ellipse at top, rgba(0, 0, 0, 0.15) 0%, transparent 50%)'
          }}
        />
        <div 
          className="absolute inset-0 opacity-20"
          style={{
            background: 'linear-gradient(180deg, rgba(253, 181, 21, 0.3) 0%, rgba(224, 54, 148, 0.4) 100%)'
          }}
        />
