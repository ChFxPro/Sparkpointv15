...
export default defineConfig({
  // IMPORTANT: GitHub Pages serves this site from /sparkpointv15/
  // Without this, built JS/CSS will 404 and the site will appear blank.
  base: '/sparkpointv15/',
  ...
  resolve: {
    ...
    alias: {
      ...
      'figma:asset/b3266e92dcd32745ada3032a9087d9677176b3eb.png': path.resolve(
        __dirname,
        './src/assets/b3266e92dcd32745ada3032a9087d9677176b3eb.png'
      ),
